...
,
					"patching_rect" : [ 336.0, 105.0, 157.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 47.0, 177.0, 157.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 336.0, 61.0, 211.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 47.0, 133.0, 211.0, 33.0 ],
					"text" : "MAPPING IS OFF",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 42.0, 45.0, 42.0, 20.0 ],
					"text" : "active"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 225.0, 151.0, 18.0 ],
					"text" : "/slider.1/val"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 266.5, 220.0, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 182.0, 225.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 266.5, 199.0, 148.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 256.5, 74.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 256.5, 108.0, 58.0, 18.0 ],
					"text" : "open $1"
				}
...
,
					"patching_rect" : [ 152.0, 250.0, 92.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 256.5, 132.0, 168.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 132.0, 58.0, 20.0 ],
					"text" : "s UI/step"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 42.0, 100.0, 112.0, 20.0 ],
					"text" : "t erase b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 42.0, 74.0, 65.0, 20.0 ],
					"text" : "qmetro 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 59.0, 178.0, 112.0, 62.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 16.0, 507.0, 200.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 42.0, 132.0, 85.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 161.5, 283.0, 45.0, 283.0, 45.0, 168.0, 68.5, 168.0 ],
					"source" : [ "obj-73", 0 ]
				}
